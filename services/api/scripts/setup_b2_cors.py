...
def _client():
    ...
    # client leaves region unset for object ops. The region is the configured
    # B2_REGION — no hardcoded region string.
    return boto3.client(
        "s3",
        ...
        config=Config(
            ...
            user_agent_extra="b2ai-mmdetection3d-lidar-dataset",
        ),
    )
